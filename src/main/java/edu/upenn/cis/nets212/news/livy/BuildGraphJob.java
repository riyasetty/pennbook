...
public class BuildGraphJob implements Job<List<MyPair<String, List<List<Object>>>>> {
	/**
	 * 
	 */
	 ...
	 */
	public List<MyPair<String, List<List<Object>>>>  run() throws IOException, InterruptedException {
		...
		List<MyPair<String, List<List<Object>>>> pairRecs = new LinkedList<MyPair<String, List<List<Object>>>>();
		for (Tuple2<String, List<List<Object>>> rec : recommendations) {
			pairRecs.add(new MyPair<String, List<List<Object>>>(rec._1, rec._2));
		}
	...
	public BuildGraphJob() {
		System.setProperty("file.encoding", "UTF-8");
	}

	@Override
	public List<MyPair<String, List<List<Object>>>> call(JobContext arg0) throws Exception {
		initialize();
		return run();
	}
}
